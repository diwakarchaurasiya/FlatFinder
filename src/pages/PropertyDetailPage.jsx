...
import { FaBed, FaBath, FaRulerCombined, FaMapMarkerAlt, FaCalendarAlt, FaRupeeSign, FaPhone, FaHeart, FaRegHeart, FaShareAlt, FaCheckCircle } from 'react-icons/fa';
...
const PropertyDetailPage = () => {
  ...
  if (error) {
    return (
      <div className="container mx-auto px-4 py-16 text-center">
        <h2 className="text-2xl font-semibold text-neutral-800 mb-4">{error}</h2>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-wrap justify-between items-start mb-6">
          ...
          <div className="mt-4 md:mt-0">
            <div className="text-xl md:text-2xl font-bold text-primary-600 flex items-center">
              ...
              {property.isRent && <span className="text-neutral-500 font-normal text-base ml-1">/month</span>}
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="text-center p-4">
                  <div className="flex flex-col items-center">
                    ...
                    <div>
                      <div className="font-semibold text-lg">{property.sqft}</div>
            ...
            {/* Description */}
            <div className="bg-white shadow-md rounded-lg p-6 mb-8">
              <h2 className="text-xl font-semibold text-secondary-800 mb-4">Description</h2>
              <p className="text-neutral-700 mb-4">{property.description}</p>
              <div className="grid grid-cols-2 gap-4 mt-6">
                <div className="flex items-center">
                  <FaCalendarAlt className="text-primary-500 mr-2" />
                  <div>
                    <div className="text-sm text-neutral-500">Available From</div>
                    <div className="font-medium">{new Date(property.availableFrom).toLocaleDateString('en-IN')}</div>
                  </div>
                </div>
                <div className="flex items-center">
            ...
            {/* Amenities */}
            <div className="bg-white shadow-md rounded-lg p-6 mb-8">
              <h2 className="text-xl font-semibold text-secondary-800 mb-4">Amenities</h2>
          ...
          <div className="lg:col-span-1">
            ...
            <div className="bg-white shadow-md rounded-lg p-6 mb-6 sticky top-24">
              <h3 className="text-lg font-semibold text-secondary-800 mb-4">Contact Owner</h3>
              ...
              <div className="mb-4">
                ...
                <div className="text-sm text-neutral-600 mt-2">
                  ...
                  <span className="text-green-600 font-medium">{property.owner.responseTime}</span>
                </div>
              </div>
              ...
              {isContactVisible ? (
                <div className="animate-fade-in">
                  <div className="bg-neutral-50 p-3 rounded-md mb-4">
                    <div className="text-sm text-neutral-500 mb-1">Contact Number</div>
                    <div className="font-medium text-secondary-800 flex items-center">
                      <FaPhone className="mr-2 text-primary-500" />
                      <a href={`tel:${property.owner.contact}`}>{property.owner.contact}</a>
                    </div>
                  </div>
                  <button
