  ...
  return (
    <div className="py-12">
      <div className="container mx-auto px-4">
        ...
        >
          <h1 className="text-3xl font-bold text-secondary-800 mb-4">Contact Us</h1>
          <p className="text-neutral-600 max-w-2xl mx-auto">
            Have questions about a property or need assistance? Get in touch with our team and we'll be happy to help.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <motion.div 
            ...
            className="bg-secondary-700 text-white rounded-lg shadow-lg p-8"
          >
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-neutral-200 mt-1">123 Main Street, Jaipur, Rajasthan 302001</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-neutral-200 mt-1">+91 98765 43210</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-neutral-200 mt-1">info@flatfinder.com</p>
                </div>
              </div>
          ...
          >
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-neutral-700 mb-1" htmlFor="subject">
                    Subject
                  </label>
                  <input
                    type="text"
